            ...
            <div className="relative bg-white dark:bg-gray-800 rounded-xl shadow-xl overflow-hidden border border-gray-200 dark:border-gray-700">
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-lg font-semibold">Coffee Shop Queue</h3>
                ...
                >
                  ...
                  <p className="text-sm text-gray-700 dark:text-gray-300">
                    Based on current traffic patterns, consider adding another
                    staff member between 2-4 PM to reduce average wait time by
                    40%.
                  </p>
                </motion.div>
              </div>
