...
export async function POST(request) {
  try {
    ...
    // Send queue created notifications
    try {
      await NotificationService.sendQueueCreatedNotifications(queue, user)
    } catch (error) {
      console.error("Failed to send queue created notifications:", error)
